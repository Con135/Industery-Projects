...
public class Exercise31_22 extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    FlowPane flowPane1 = new FlowPane(3, 3);
    FlowPane flowPane2 = new FlowPane(3, 3);
    ...
    flowPane1.getChildren().addAll(new Label("Country: "),
      tfCountry, new Label("Capital"), tfCapital, 
      new Label("Population"), tfPopulation, chkDemocratic, 
      btAddRow);
    flowPane2.getChildren().addAll(btDeleteRow);
    ...
    btDeleteRow.setOnAction(e -> {
    	...
    	data.remove(selectedCountry);
    });
    
    
    BorderPane pane = new BorderPane();
    pane.setCenter(tableView);
    pane.setBottom(flowPane1);
    pane.setTop(flowPane2);
